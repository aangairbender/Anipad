...
namespace Anipad
{
    ...
    {
        public const string AppName = "Anipad";

        public const string DefaultFilename = "Unnamed";

        public const string TextEditorConfigFilename = "config.txt";

        public const TextWrapping DefaultTextWrapping = TextWrapping.Wrap;

        public const string DefautFontFamilyName = "Consolas";
